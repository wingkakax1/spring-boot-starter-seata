...
//        throw new RuntimeException("test");
    ...
    @GlobalTransactional(timeoutMills = 300000, name = "spring-cloud-demo-tx")
    @RequestMapping(value = "/fescar/rest2", method = RequestMethod.GET, produces = "application/json")
    public String rest2() {

        String result = restTemplate.getForObject(
                "http://127.0.0.1:18082/storageAdd/" + COMMODITY_CODE + "/" + ORDER_COUNT,
                String.class);
